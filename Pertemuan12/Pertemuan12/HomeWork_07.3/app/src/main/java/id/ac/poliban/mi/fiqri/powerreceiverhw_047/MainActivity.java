package id.ac.poliban.mi.fiqri.powerreceiverhw_047;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.mi.fiqri.powerreceiverhw_047.RANDOM_NUMBER";
