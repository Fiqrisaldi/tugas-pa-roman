package id.ac.poliban.mi.fiqri.twoactivitiesespresso_047;
...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY ="id.ac.poliban.mi.fiqri.twoactivitiesespresso_047.extra.REPLY";
