package id.ac.poliban.mi.fiqri.simpleshoppinglist;
...
import id.ac.poliban.mi.fiqri.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.fiqri.simpleshoppinglist.EXTRA.ITEM";
